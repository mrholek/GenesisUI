                ...
                resolve: {
                    loadPlugin: ['$ocLazyLoad', function ($ocLazyLoad) {
                        ...
                        return $ocLazyLoad.load([{
                            serie: true,
                            name: 'chart.js',
                            files: ['dist/js/libs/Chart.min.js', 'dist/js/libs/angular-chart.min.js']
                        }]);
                    }],
                    loadMyCtrl: ['$ocLazyLoad', function($ocLazyLoad) {
                        // you can lazy load controllers
                        return $ocLazyLoad.load({
                            files: ['dist/js/controllers/shared.js']
                        });
                    }]
                }
            })
                ...
                resolve: {
                    loadPlugin: ['$ocLazyLoad', function ($ocLazyLoad) {
                        ...
                        return $ocLazyLoad.load([
                            {
                                serie: true,
                                files: ['dist/js/libs/moment.min.js']
                            },
                            {
                                serie: true,
                                files: ['dist/js/libs/daterangepicker.min.js', 'dist/js/libs/angular-daterangepicker.min.js']
                            },
                            {
                                serie: true,
                                name: 'chart.js',
                            ...
                            {
                                serie: true,
                                files: ['dist/js/libs/gauge.min.js']
                            },
                            {
                                serie: true,
                                files: ['dist/js/libs/angular-toastr.tpls.min.js']
                            }
                        ]);
                    }],
                    loadMyCtrl: ['$ocLazyLoad', function($ocLazyLoad) {
            ...
            .state('app.uikits.email.compose', {
                ...
                resolve: {
                    loadPlugin: ['$ocLazyLoad', function ($ocLazyLoad) {
                        ...
                        return $ocLazyLoad.load([
                            {
                                files: ['dist/js/libs/select.min.js']
                            }
                        ]);
                    }],
                    loadMyCtrl: ['$ocLazyLoad', function($ocLazyLoad) {
                        // you can lazy load controllers
                        return $ocLazyLoad.load({
                            files: ['dist/js/controllers/uikits/email.js']
                        });
                    }]
                }
            })
