module.exports = function (grunt) {
      	...
      	copy: {
            ...
            dev: {
                files: [{
                    ...
                    dest: '../build/Angular_Dev/dist',
                    filter: 'isFile'
                }, {
                    expand: true,
                    src:['views/**'],
                    dest: '../build/Angular_Dev/',
                    filter: 'isFile'
                }, {
                    expand: true,
                    flatten: true,
                    src: 'fonts/**',
                    dest:'../build/Angular_Dev/dist/fonts',
                    filter: 'isFile'
                }, {
                    expand: true,
                    src: ['data.json'],
                    ...
                    dest: '../build/Angular_Dev/index.html'
                }]
            }
        },
        replace: {
            devJs:{
                src: [
                    '../build/Angular_Dev/dist/js/routes.js',
                    '../build/Angular_Dev/dist/js/controllers/*.js',
                    '../build/Angular_Dev/dist/js/controllers/uikits/*.js'
                ],
                overwrite: true,
                replacements: [{
                    from: '\'js/libs',
            ...
            devViews: {
                src: ['../build/Angular_Dev/views/*.html', '../build/Angular_Dev/views/**/*.html'],
                overwrite: true,
                replacements: [{
                    from: '"img/',
                    to: '"dist/img/',
    ...
    grunt.registerTask('build-dev',         ['copy:dev', 'replace:devJs', 'replace:devViews']);
